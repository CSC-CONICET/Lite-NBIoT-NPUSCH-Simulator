...
%                 end
            ...
            %         end
                    ...
                    for rep = [0:NPUSCH.NREP-1]
                        ...
                        %randreal=randn(npuschSize);
                        %randimag=randn(npuschSize);
                        %noise = (1/sqrt(2*snr))*complex(randn(npuschSize),randn(npuschSize));
                    ...
                    % been received
                       ...
                       % Viterbi decode
                       bitsDecoded = lteTurboDecode(sfbitsRateRecovered,30);
                       % CRC decode
